...
final class DeepLinkAndTimePolicyTests: XCTestCase {
    func testDeepLinkRouterParsesKnownRoutes() {
        XCTAssertEqual(DeepLinkRouter.parse(URL(string: "justone://quickEntry")!), .quickEntry)
        XCTAssertEqual(DeepLinkRouter.parse(URL(string: "justone://home")!), .home)
        XCTAssertEqual(DeepLinkRouter.parse(URL(string: "justone://statistics")!), .statistics)
    }

    func testDeepLinkRouterRejectsUnknownRouteOrScheme() {
        XCTAssertNil(DeepLinkRouter.parse(URL(string: "justone://unknown")!))
