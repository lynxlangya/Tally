...
enum TallyLocalization {
    ...
    private static let extraFallbackTextByLanguage: [String: [String: String]] = [
        "en": [
            ...
            "csv_import_timezone_note": "Note: CSV has no time zone info. Dates will be interpreted in your current device time zone.",
            "import_success_count": "Imported: %d",
            "import_skipped_count": "Skipped: %d",
            "import_error_summary": "Error Summary:",
            "import_failed_generic": "Import failed. Check the file and try again.",
            "data_load_failed": "Data could not be loaded. Please try again later.",
        ...
        "zh-Hans": [
            ...
            "csv_import_timezone_note": "提示：CSV 不含时区信息，账单日期将按当前设备时区解析。",
            "import_success_count": "成功：%d",
            "import_skipped_count": "跳过：%d",
            "import_error_summary": "错误摘要：",
            "import_failed_generic": "导入失败，请检查文件后重试",
