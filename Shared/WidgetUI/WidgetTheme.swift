...
enum WidgetTheme {
    ...
    static func compactMoney(
        ...
        let symbol = MoneyDisplaySymbol.allCases.first { $0.symbol == currencySymbol } ?? .default
        return MoneyFormatter.compactString(fromCents: cents, locale: locale, symbol: symbol)
    }
}
