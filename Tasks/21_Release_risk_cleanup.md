...
- 最小验证：`xcodebuild test -project JustOne.xcodeproj -scheme JustOneTests -destination 'platform=iOS Simulator,id=8323F09A-7C0F-47BA-85F5-6FDA28BA9CFF' CODE_SIGNING_ALLOWED=NO -only-testing:JustOneTests/HomeViewModelTests` 通过。
...
- 最小验证：`xcodebuild test -project JustOne.xcodeproj -scheme JustOneTests -destination 'platform=iOS Simulator,id=8323F09A-7C0F-47BA-85F5-6FDA28BA9CFF' CODE_SIGNING_ALLOWED=NO -only-testing:JustOneTests/RecurringBillFormViewModelTests -only-testing:JustOneTests/DefaultRecurringServiceTests` 通过。
...
- 最小验证：`xcodebuild test -project JustOne.xcodeproj -scheme JustOneTests -destination 'platform=iOS Simulator,id=8323F09A-7C0F-47BA-85F5-6FDA28BA9CFF' CODE_SIGNING_ALLOWED=NO -only-testing:JustOneTests/HomeViewModelTests -only-testing:JustOneTests/ImportExportViewModelTests -only-testing:JustOneTests/CSVImportPipelineTests` 通过。
...
- 最小验证：`xcodebuild test -project JustOne.xcodeproj -scheme JustOneTests -destination 'platform=iOS Simulator,id=8323F09A-7C0F-47BA-85F5-6FDA28BA9CFF' CODE_SIGNING_ALLOWED=NO -only-testing:JustOneTests/CoreDataImportWriteRepositoryTests -only-testing:JustOneTests/CSVImportPipelineTests` 通过。
