...
enum BillsListLayout {
    ...
    static let timeRangeBottomPadding: CGFloat = 2
    static let footerBottomOffset: CGFloat = 0
    static let trendHeight: CGFloat = 120
    static let trendLineWidth: CGFloat = 6
    static let trendDotSize: CGFloat = 8
    static let trendDotStroke: CGFloat = 2
    static let trendTooltipOffset: CGFloat = 24
    static let trendTooltipMinY: CGFloat = 12
